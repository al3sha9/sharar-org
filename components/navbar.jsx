...
export const Nav = () => {
  ...
  return (
    <div className="bg-[#135858] shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]   top-0 z-[1000000]">
          ...
          <ul className="flex items-center hidden space-x-8 lg:flex">
            ...
            <li>
              <Link
                ...
                title="Contact Us"
                className="inline-flex items-center justify-center  h-12 px-8 font-medium tracking-wide  transition duration-200 rounded shadow-md bg-white hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
              >
                Contact Us
              </Link>
            </li>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div>
                      <button
                        ...
                        title="Close Menu"
                        className="p-2 -mt-2 -mr-2 transition duration-200 rounde hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                    ...
                    <ul className="space-y-4">
                      ...
                      <li>
                        <Link
                          ...
                          className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-[#135858]  focus:shadow-outline focus:outline-none"
                          aria-label="Sign up"
                          title="Sign up"
                        >
                          Contact Us
